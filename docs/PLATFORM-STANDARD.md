...
[lego](http://lego.oa.com)基于[spm](http://spmjs.io/)基础之上，完善组件分类体系，组件认证体系，组件反馈体系的完整的组件使用生态系统。协助组件使用者在组件选择、信任组件、组件使用中更好的参与到组件生态系统中。

+	**GitHub开源**
	+	[lego](https://github.com/imweb/lego)与[lego.oa.com](https://github.com/webryan/lego.imweb.io)（`需要权限才能访问`）
	+	如需要，访问[spm](https://github.com/spmjs/spm)与[spm.io](https://github.com/spmjs/spmjs.io)
+	组件平台

	组件平台分类[客户端](https://github.com/imweb/lego)以及[服务平台](http://lego.oa.com)
...
+	客户端安装&使用（`文档还在完善中`）
	...
	**lego doc** `文档生成`，如：[jquery](http://lego.oa.com/docs/jquery/latest/)
...
+	**组件分类**
	...
	+	基础组件
		诸如[jquery](http://lego.oa.com/package/jquery)等基础框架组件
	+	工具组件
...
+	组件认证
	...
	组件开发者通过平台，[提交](http://lego.oa.com/authen/apply/expect.js)组件认证。
